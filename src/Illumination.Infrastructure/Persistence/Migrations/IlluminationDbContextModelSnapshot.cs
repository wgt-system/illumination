...
#pragma warning disable 612, 618
        ...
        // Keep the snapshot self-contained. It must describe the frozen migration model
        // rather than delegating to the live persistence configuration.
        ConfigurePersistenceModel(modelBuilder);
        ConfigureDeckTopics(modelBuilder);
#pragma warning restore 612, 618
    }

    private static void ConfigurePersistenceModel(ModelBuilder modelBuilder)
    {
    ...
    private static void ConfigureDeckTopics(ModelBuilder modelBuilder)
    {
    ...
    private static void ConfigureHint(EntityTypeBuilder<HintRecord> entity)
    {
        ...
        entity.HasKey(x => new { x.LearningItemId, x.Position });
        entity.Property(x => x.LearningItemId).HasColumnName("LearningItemId");
    ...
    {
        entity.ToTable("AnswerChoices");
        entity.HasKey(x => new { x.LearningItemId, x.Role, x.Position });
        entity.Property(x => x.LearningItemId).HasColumnName("LearningItemId");
        entity.Property(x => x.Role).HasColumnName("Role").HasConversion<string>();
        entity.Property(x => x.Position).HasColumnName("Position");
        entity.Property(x => x.ChoiceId).HasColumnName("ChoiceId");
        entity.Property(x => x.Text).HasColumnName("Text").IsRequired();
        entity.Property(x => x.IsCorrect).HasColumnName("IsCorrect").IsRequired();
    ...
    {
        entity.ToTable("AcceptedShortAnswers");
        entity.HasKey(x => new { x.LearningItemId, x.Position });
        entity.Property(x => x.LearningItemId).HasColumnName("LearningItemId");
        entity.Property(x => x.Position).HasColumnName("Position");
    ...
    private static void ConfigureDeck(EntityTypeBuilder<DeckRecord> entity)
    {
        ...
        entity.Property(x => x.DeckId).HasColumnName("DeckId").ValueGeneratedNever();
    ...
    {
        entity.ToTable("DeckLearningItems");
        entity.HasKey(x => new { x.DeckId, x.LearningItemId });
        entity.Property(x => x.DeckId).HasColumnName("DeckId");
        entity.Property(x => x.LearningItemId).HasColumnName("LearningItemId");
    }
