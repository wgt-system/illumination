...
public class PersistenceTests
{
    ...
    public void Migrations_create_the_schema_and_can_be_applied_again()
    {
        ...
        Assert.Equal(["AcceptedShortAnswers", "AnswerChoices", "DeckLearningActivityProfiles", "DeckLearningItems", "DeckTopicLabels", "Decks", "Hints", "ImportProvenance", "LearningItemUserFlags", "LearningItems", "QualityReviews", "Reviews", "StudyPreferences", "StudySessionDecks", "StudySessionQueue", "StudySessionReviews", "StudySessions", "UserFlagDefinitions"], tableNames);
    }
